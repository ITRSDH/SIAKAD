...
@section('title', 'Buat Dosen Mata Kuliah')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Form Tambah Dosen Mata Kuliah</div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('dosen-mk.store') }}" method="POST">
                            @csrf
            ...
            if (typeof $ !== 'undefined') {
                $(document).ready(function() {
                    ...
                    $('#id_kelas_mk').on('select2:select', function(e) {
                        ...
                        $('#kelas_pararel_display').val('Program Studi ' + $selected.data('nama-prodi') + ' - ' +
                            ' Kelas ' + $selected.data('nama-kelas') +
                            ' (Angkatan ' +
                            $selected.data('angkatan') + ')' || '');
