...
@section('content')
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Kelas Kuliah</h3>
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                    <a href="{{ route('kelas-kuliah.index') }}">List Kelas Kuliah</a>
                </li>
            </ul>
        </div>
                            ...
                            <table id="kelas-kuliah-table"
                                ...
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th width="10%" class="text-center">Kode MK</th>
                                        <th width="10%" class="text-center">Nama Mata Kuliah</th>
                                        <th width="5%" class="text-center">Nama Kelas</th>
                                        <th width="5%" class="text-center">Bobot MK(sks)</th>
        ...
        $(document).ready(function() {
            ...
            var table = $('#kelas-kuliah-table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'mata_kuliah.kode_mk',
                        className: 'text-center',
                        render: function(data, type, row) {
                            var detailUrl = "{{ route('kelas-kuliah.detail', ':id') }}".replace(
                                ':id',
                                row
                                .id);
                            return `
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            if (data === null || data === undefined || data === '') {
                                return '<span class="badge bg-warning text-dark">Belum Diisi</span>';
                            }
                            ...
                            return `
                                <div class="d-flex justify-content-center gap-2 flex-wrap">
                                        <a href="${detailUrl}" class="btn btn-warning btn-sm text-white">
                                          ...
                                          <button class="btn btn-danger btn-sm delete-btn" data-id="${row.id}" data-nama="${row.nama_kelas}">
            ...
            $('#kelas-kuliah-table').on('click', '.detail-btn', function() {
                let id = $(this).data('id');
