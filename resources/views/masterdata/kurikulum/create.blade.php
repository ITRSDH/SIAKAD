                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="jumlah_sks_pilihan"
                                            name="jumlah_sks_pilihan" placeholder="0" min="0" value="0" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="jumlah_sks_lulus"
                                            name="jumlah_sks_lulus" placeholder="0" readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="jumlah_sks_wajib"
                                            name="jumlah_sks_wajib" placeholder="0" min="0" value="0" required>
                                    </div>
                                </div>
                            </div>
                        </form>
