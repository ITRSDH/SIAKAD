                                            ...
                                            @if (isset($semester) && count($semester) > 0)
                                                @foreach ($semester as $item)
                                                    <option value="{{ $item['id'] }}"
                                                        {{ ($periodeKRS['id_semester'] ?? '') == $item['id'] ? 'selected' : '' }}>
                                                        {{ $item['semester'] }}
                                                    </option>
                                                @endforeach
                                            @endif
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="tanggal_mulai" name="tanggal_mulai"
                                            value="{{ \Carbon\Carbon::parse($periodeKRS['tanggal_mulai'] ?? null)->format('Y-m-d') }}"
                                            required>
                                        @error('tanggal_mulai')
                                            <div class="text-danger small">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="tanggal_selesai"
                                            ...
                                            value="{{ \Carbon\Carbon::parse($periodeKRS['tanggal_selesai'] ?? null)->format('Y-m-d') }}"
                                            required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="status" name="status" required>
                                            ...
                                            <option value="draft"
                                                {{ ($periodeKRS['status'] ?? '') == 'draft' ? 'selected' : '' }}>Draft
                                            </option>
                                            <option value="aktif"
                                                {{ ($periodeKRS['status'] ?? '') == 'aktif' ? 'selected' : '' }}>Aktif
                                            </option>
                                            <option value="ditutup"
                                                {{ ($periodeKRS['status'] ?? '') == 'ditutup' ? 'selected' : '' }}>Ditutup
                                            </option>
                                        </select>
                                        @error('status')
                                            <div class="text-danger small">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="catatan" name="catatan" rows="3"
                                            placeholder="Opsional: Masukkan catatan tambahan">{{ $periodeKRS['catatan'] ?? '' }}</textarea>
                                        @error('catatan')
                                            <div class="text-danger small">{{ $message }}</div>
                                        @enderror
                                    </div>
