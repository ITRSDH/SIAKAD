...
@section('title', 'Tambah Ruang Kuliah')
    ...
    <div class="page-inner">
        <div class="page-header">
            ...
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                    <a href="{{ route('ruang-kuliah.create') }}">Tambah Ruang Kuliah</a>
                </li>
            </ul>
        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="card-title">Tambah Ruang Kuliah</h4>
                    ...
                    <div class="card-body">
                        ...
                        <form id="formCreate" method="POST" action="{{ route('ruang-kuliah.store') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
